...
function deleteArchive($key) {
	...
	$objResponse->assign("btnIntDelete$key","value","Възстанови");
	$objResponse->call("DisableEnableForm",false);
...
function uploadExtDB($aFormValues=null) {
	...
	$fname = trim($aFormValues['archivedb']);
	if($fname == '') {
        ...
        <div id="sub4" class="submenu">
          <table border="0" cellpadding="0" cellspacing="0" class="xlstable" id="listtable">
            ...
            <tr>
              ...
              <td width="12%"><input type="button" id="btnDownload<?=$key?>" name="btnDownload<?=$key?>" value="Свали" onclick="window.location.href='download.php?i=db/BKP<?=$key?>.db'" class="nicerButtons" />
              </td>
          ...
          <table id="listtable">
            <tbody>
              ...
              <tr id="line_<?=$row['user_id']?>">
                <td align="left"><?php if('demo' == $row["user_name"]) { ?><strong>demo</strong><input type="hidden" id="user_name_<?=$row['user_id']?>" name="user_name_<?=$row['user_id']?>" value="<?=$row["user_name"]?>" /><?php } else { ?><input type="text" id="user_name_<?=$row['user_id']?>" name="user_name_<?=$row['user_id']?>" value="<?=HTMLFormat($row["user_name"])?>" size="40" maxlength="60" /><?php } ?></td>
                <td align="left"><input type="text" id="user_pass_<?=$row['user_id']?>" name="user_pass_<?=$row['user_id']?>" value="<?=HTMLFormat($row["user_pass"])?>" size="40" maxlength="60" /></td>
                <td align="left"><input type="text" id="fname_<?=$row['user_id']?>" name="fname_<?=$row['user_id']?>" value="<?=HTMLFormat($row["fname"])?>" size="40" maxlength="60" /></td>
                <td align="left"><input type="text" id="lname_<?=$row['user_id']?>" name="lname_<?=$row['user_id']?>" value="<?=HTMLFormat($row["lname"])?>" size="40" maxlength="60" /></td>
              ...
              ?>
              <tr>
                <td align="left"><input type="text" id="user_name_0" name="user_name_0" value="" size="40" maxlength="60" class="newItem" /></td>
                <td align="left"><input type="text" id="user_pass_0" name="user_pass_0" value="" size="40" maxlength="60" class="newItem" /></td>
                <td align="left"><input type="text" id="fname_0" name="fname_0" value="" size="40" maxlength="60" class="newItem" /></td>
                <td align="left"><input type="text" id="lname_0" name="lname_0" value="" size="40" maxlength="60" class="newItem" /></td>
                <td align="left">&nbsp;</td>
                <td align="left">&nbsp;</td>
                <td align="left">&nbsp;</td>
              </tr>
...
?>
	...
	window.onload = function() {
		window.location.href='download.php?i=<?=$_SESSION['sess_bkpDB']?>';
	}
	//]]>
	</script>
