      ...
      <form id="frmFirm" action="javascript:void(null);">
        ...
        <table cellpadding="0" cellspacing="0" class="formBg">
          ...
          <tr>
            ...
            <td class="rightSplit"><input type="text" id="contract_begin" name="contract_begin" value="<?=HTMLFormat($row['contract_begin2'])?>" size="20" maxlength="10" onchange="xajax_calcContractEnd(this.value);return false;" />
              г. </td>
          </tr>
          <tr>
            <td>Дата на изтичане: </td>
            <td class="rightSplit"><input type="text" id="contract_end" name="contract_end" value="<?=HTMLFormat($row['contract_end2'])?>" size="20" maxlength="10" onchange="xajax_formatBGDate(this.name,this.value);return false;" />
              г. </td>
          </tr>
          <tr>
...
function echoWorkers($firm_id)
{
	...
	if (isset($_GET['btnFind'])) { // Filter workers
		if (isset($_GET['keyword']) && trim($_GET['keyword']) != '') {
			...
			$txtCondition .= "(w.egn LIKE '$keyword%' OR w.fname LIKE '%$keyword%' OR w.lname LIKE '%$keyword%' OR w.fname LIKE '%$uc_keyword%' OR w.lname LIKE '%$uc_keyword%')";
		}
	}
        ...
        <div id="sub1" class="submenu">
          ...
          <table id="listtable">
            <tbody>
              ...
              <?php
				...
				?>
              <tr>
                <td colspan="13">Няма намерени резултати.</td>
              </tr>
              <?php } ?>
              <tr class="notover">
                <td colspan="13">&nbsp;</td>
              ...
              <tr>
                <th colspan="13" align="center"><input type="button" id="btnSubmit" name="btnSubmit" value="Нов работещ" class="nicerButtons" /></th>
              </tr>
            </tbody>
          </table>
          <div id="actionsdiv">
          ...
          <?php if (is_array($workers) && count($workers) > 0) { ?>
            <table cellpadding="0" cellspacing="0" width="99%" class="formBg" align="left">
              ...
              <tr>
                <td><a id="lnkMChkup" href="#" title="Справка болнични листове"><img src="img/medical3.gif" width="16" height="16" border="0" alt="Списък" /> Справка болнични листове за периода</a> от <input type="text" id="date_from3" name="date_from3" value="" size="18" maxlength="10" onchange="xajax_formatBGDate('date_from3',this.value);return false;" /> г. до <input type="text" id="date_to3" name="date_to3" value="<?=date("d.m.Y", time())?>" size="18" maxlength="10" onchange="xajax_formatBGDate('date_to3',this.value);return false;" /> г. &nbsp;&nbsp;&nbsp;<input type="checkbox" id="sickonly" name="sickonly" value="1" checked="checked" /> покажи само работещите с болнични</td>
              </tr>
              <tr>
