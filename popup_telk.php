          ...
          <table cellpadding="0" cellspacing="0" border="0" width="99%">
            <tr>
              <td colspan="2">Експ. решение №
                ...
                <input type="text" id="telk_date_from" name="telk_date_from" value="<?=((isset($f['telk_date_from']))?HTMLFormat($f['telk_date_from']):'')?>" size="18" maxlength="10" onchange="xajax_formatBGDate('telk_date_from',this.value);return false;" />
                г. <br />
                Срок на инвалидността до:
                <input type="text" id="telk_date_to" name="telk_date_to" value="<?=((isset($f['telk_date_to']))?HTMLFormat($f['telk_date_to']):'')?>" size="18" maxlength="10" onchange="xajax_formatBGDate('telk_date_to',this.value);return false;" />
                г. за
                ...
                <div class="br"></div>
                Дата на първа инвалидизация: <input type="text" id="first_inv_date" name="first_inv_date" value="<?=((isset($f['first_inv_date']))?HTMLFormat($f['first_inv_date']):'')?>" size="18" maxlength="10" onchange="xajax_formatBGDate('first_inv_date',this.value);return false;" /> г.
                <div class="br"></div>
