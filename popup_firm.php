  ...
  <form id="frmFirm" action="javascript:void(null);">
    ...
    <table cellpadding="0" cellspacing="0" class="formBg">
      ...
      <tr>
        ...
        <td class="rightSplit"><input type="text" id="contract_begin" name="contract_begin" value="" size="20" maxlength="10" onchange="xajax_calcContractEnd(this.value);return false;" />
          г. </td>
      </tr>
      <tr>
        <td class="leftSplit">Дата на изтичане: </td>
        <td class="rightSplit"><input type="text" id="contract_end" name="contract_end" value="" size="20" maxlength="10" onchange="xajax_formatBGDate(this.name,this.value);return false;" />
          г. </td>
      </tr>
      <tr>
