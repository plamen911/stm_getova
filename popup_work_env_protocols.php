            ...
            <tbody>
              ...
              <tr class="underline">
                ...
                <td colspan="6"><strong>Протокол №:</strong>
                  ...
                  <input type="text" id="prot_date_<?=$map_id?>" name="prot_date_<?=$map_id?>" value="<?=HTMLFormat($row['prot_date_h'])?>" onchange="xajax_formatProtDate(this.value, '<?=$map_id?>');return false;" /></td>
              </tr>
              <?php
              $i++;
              	}
              ...
              <tr<?=((!($i%2))?'':' class="alternate"')?>>
                ...
                <td colspan="6"><strong>Протокол №:</strong>
                  ...
                  <strong>от дата:</strong>
                  <input type="text" id="prot_date_0" name="prot_date_0" value="" class="newItem" onchange="xajax_formatProtDate(this.value, '0');return false;" /></td>
              </tr>
            </tbody>
          </table>
	<?php
