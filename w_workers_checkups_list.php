<?php
// http://localhost/stm2008/w_workers_checkups_list.php?firm_id=39&date_from=01.01.2007&date_to=31.12.2008&offline=1
...
$rows = $dbInst->getWorkers($firm_id);
...
$query = "	SELECT w.*, strftime('%d.%m.%Y г.', c.checkup_date, 'localtime') AS checkup_date2,
			f.name AS firm_name, 
			l.location_name,
			s.subdivision_name,
			p.wplace_name,
			...
			ORDER BY w.worker_id, w.fname, w.sname, w.lname";
