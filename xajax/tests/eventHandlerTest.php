...
<div>
<input type='radio' name='handler[]' value='add' onclick="xajax_addHandler('myDiv','clickHandler1'); return false;" />
<input type='radio' name='handler[]' value='remove' onclick="xajax_removeHandler('myDiv','clickHandler1'); return false;" />
</div>
<div>
