                  ...
                  <tr>
                    <td><div id="diagnosisWrapper">
                        <table cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td class="primary"><strong id="mkb_code_<?=$row['prchk_id']?>"><?=HTMLFormat($row['mkb_code'])?></strong></td>
                  ...
                  <tr>
                    <td><table>
                        ...
                        <tr>
                          ...
                          <td><input type="text" id="prchk_stm_date" name="prchk_stm_date" value="<?=((isset($f['prchk_stm_date2']))?HTMLFormat($f['prchk_stm_date2']):date("d.m.Y"))?>" onchange="xajax_formatBGDate('prchk_stm_date', this.value);return false;" size="20" maxlength="10" /> г.</td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
    ...
    <table cellpadding="0" cellspacing="0" class="formBg" width="770">
      ...
      <tr>
        <td class="leftSplit rightSplit">ЕГН:
          ...
          &nbsp;&nbsp; <strong>Дата:</strong>
          <input type="text" id="prchk_date" name="prchk_date" value="<?=((isset($f['prchk_date2'])&&$precheckup_id)?HTMLFormat($f['prchk_date2']):'')?>" onchange="xajax_formatBGDate('prchk_date', this.value);return false;" size="20" maxlength="10"<?=$readonly?> />
          г.
          <div class="hr"></div>
